...
enum JenisKelamin {pria, wanita}; /* Definisikan enumerasi yang bernama JenisKelamin dengan isi konstanta pria dan wanita*/

int main(void) {

      char nama[25]; /* Deklarasikan variabel nama bertipe string, dengan panjang data sebesar 25 */
