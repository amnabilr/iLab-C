...
struct data
{
    char nama[50];
    char npm[10];
    float ipk;/* Definisikan strukur yang bernama 'data' dengan isi data
...
int main()
{
    ...
    printf("BESAR IPK : %.2f \n",mhs.ipk);/* Menampilkan nilai yang disimpan di dalam variabel nama, npm dan ipk menggunakan perintah printf*/
